...
var countArray = function(array) {
    ...
    array.forEach(function(elemento){
        //ver si es un array o un número
...
LinkedList.prototype.changeNotNumbers = function(){
    ...
    let counter = 0;
    while (current){
        // Number.isNaN revisa si el valor no es un número
...
var mergeQueues = function(queueOne, queueTwo) {
    // Tu código aca:
    let mergedQueue = new Queue (); // para juntar dos colas necesitamos crear una tercera cola

    //iterar mientras las dos queue tengan elementos
    while (queueOne.size() || queueTwo.size()){
        // si hay elementos en la queueOne ejecutamos esto
        if (queueOne.size()) mergedQueue.enqueue(queueOne.dequeue());
        // si hay elementos en la queueTwo ejecutamos esto
